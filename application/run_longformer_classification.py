...
from dataset.papers import papers_train_set, papers_test_set
...
def main(args):
    ...
    if args.n_examples < len(dataset):
        max_entries = args.n_examples
    else:
        max_entries = len(dataset)
    ...
    num_update_steps_per_epoch = len(dataloader) // batch_size
    ...
    for epoch in range(args.epochs):
        ...
        ckpt_path = os.path.join(epoch_dir, f"model.pt")
